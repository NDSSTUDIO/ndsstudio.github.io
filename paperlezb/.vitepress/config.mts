...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '主页', link: '/' },
      { text: '最新一期', link: '/03@纸片乐子报往期内容/2024.6.4.md' }
    ],
    ...
    sidebar: [
      {
        text: '乐子报内容',
        items: [
          { text: '最新一期纸片乐子报！', link: '/03@纸片乐子报往期内容/2024.6.6.md' },
          { text: '2024.6.4', link: '/03@纸片乐子报往期内容/2024.6.4.md' },
          { text: '2024.5.29', link: '/03@纸片乐子报往期内容/2024.5.29' },
          { text: '2024.5.28', link: '/03@纸片乐子报往期内容/2024.5.28' },
          { text: '2024.5.27', link: '/03@纸片乐子报往期内容/2024.5.27' },
          { text: '2024.5.26', link: '/03@纸片乐子报往期内容/2024.5.26' },
          { text: '加入乐子报！', link: '/参与写稿及网站开发/参与.md' },
        ]
      },
      {
        text: '纸片乐子梗图',
